...
You can install the latest version (`r utils::packageVersion("EstimationTools")`) of `EstimationTools` typing the following command lines
in `R` console:
...
Or you can install the released version (`r myversion`) from  [CRAN](https://cran.r-project.org/package=EstimationTools) if you prefer. You can also type the following command lines
in `R` console:
