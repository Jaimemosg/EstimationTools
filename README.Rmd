...
You can install the lastest version (2.0.0) of `EstimationTools` typing the following command lines
in `R` console:
...
Or you can install the released version (1.2.1) from  [CRAN](https://cran.r-project.org/package=EstimationTools) if you prefer. You can also type the following command lines
in `R` console:
