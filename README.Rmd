...
You can install the latest version (2.0.0) of `EstimationTools` typing the following command lines
in `R` console:
...
You can visit the [package website](https://Jaimemosg.github.io/EstimationTools/) to explore the functions reference or our vignettes (articles).
