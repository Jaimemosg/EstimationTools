...
You can install the last version of `EstimationTools` typing the following command lines
in `R` console:
...
```
Or you can install the released version of [`EstimationTools`](https://cran.r-project.org/package=EstimationTools) from [CRAN](https://cran.r-project.org/web/packages/index.html) if you prefer. You can also type the following command lines
in `R` console:
