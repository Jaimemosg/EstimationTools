...
Note that Hessian was computed with no issues. Now, lets check the aforementioned feature in `maxlogL`: the user can implement bootstrap algorithm available in `summary` function. To illustrate this, we are going to create another object `theta_2`:
